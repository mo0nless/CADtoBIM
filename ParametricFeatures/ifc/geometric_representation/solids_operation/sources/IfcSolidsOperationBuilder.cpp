#include "../headers/IfcSolidsOperationBuilder.h"

Ifc4::IfcGeometricRepresentationItem* IfcSolidsOperationBuilder::buildIfcCreateSolidsOperation(IfcElementBundle* leftIfcRepresentationItem, IfcElementBundle* rigthIfcRepresentationItem,
	IfcReaderPropertiesBundle& ifcReaderPropertiesBundle, IfcHierarchyHelper<Ifc4>& file)
{
	...
	switch (CreateSolidFunctionsEnumUtils::getCreateSolidFunctionsEnumByClassName(ifcReaderPropertiesBundle.getClassName()))
	{
...
Ifc4::IfcGeometricRepresentationItem* IfcSolidsOperationBuilder::solveBooleanOperation(Ifc4::IfcGeometricRepresentationItem* leftIfcRepresentationItem,
