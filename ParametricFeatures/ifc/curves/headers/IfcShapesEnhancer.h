...
private:	
	Ifc4::IfcCurve* buildIfcCurvesRepresentationItems(ICurveGraphicProperties* curveProperties, IfcHierarchyHelper<Ifc4>& file, CurvesShapeTypeEnum curveContainerType);
