...
Ifc4::IfcBuildingElement* IfcElementBuilder::handleIfcBuildingElement(string nameIfcElement,Ifc4::IfcProductDefinitionShape * shape, IfcElementBundle * ifcElementBundle, IfcHierarchyHelper<Ifc4>& file)
{
	_logger->logDebug(__FILE__, __LINE__, __func__);
	...
	if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcBeam).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcBuildingElementProxy).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcChimney).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcColumn).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcCovering).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcCurtainWall).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcDoor).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcFooting).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcMember).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcPile).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcPlate).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcRailing).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcRamp).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcRampFlight).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcRoof).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcShadingDevice).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcSlab).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcStair).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcStairFlight).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcWall).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcWindow).name()))) {
		// TODO get lenght measures and replace the dummies
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcBuildingElement).name()))) {
		// TODO get lenght measures and replace the dummies
...
Ifc4::IfcCivilElement * IfcElementBuilder::handleIfcCivilElement(string nameIfcElement,Ifc4::IfcProductDefinitionShape * shape, IfcElementBundle * ifcElementBundle, IfcHierarchyHelper<Ifc4>& file)
{
	_logger->logDebug(__FILE__, __LINE__, __func__);
	...
	if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcCivilElement).name()))) {
...
Ifc4::IfcDistributionElement* IfcElementBuilder::handleIfcDistributionElement(string nameIfcElement,Ifc4::IfcProductDefinitionShape * shape, IfcElementBundle * ifcElementBundle, IfcHierarchyHelper<Ifc4>& file)
{
	_logger->logDebug(__FILE__, __LINE__, __func__);
	...
	if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcActuator).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcAirTerminal).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcAirTerminalBox).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcAirToAirHeatRecovery).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcAlarm).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcAudioVisualAppliance).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcBoiler).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcBurner).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcCableCarrierFitting).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcCableCarrierSegment).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcCableFitting).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcCableSegment).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcChiller).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcCoil).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcCommunicationsAppliance).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcCompressor).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcCondenser).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcController).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcCooledBeam).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcCoolingTower).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcDamper).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcDistributionChamberElement).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcDistributionControlElement).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcDistributionFlowElement).name()))) {
		distributionElement = new Ifc4::IfcDistributionFlowElement(guid::IfcGloballyUniqueId(to_string(ifcElementBundle->getElementId())),
			ownerHistory, elementClassName, elementDescription, boost::none,
			file.addLocalPlacement(objectPlacement), shape, boost::none);
	}
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcDuctFitting).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcDuctSilencer).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcElectricAppliance).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcElectricDistributionBoard).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcElectricFlowStorageDevice).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcElectricGenerator).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcElectricMotor).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcElectricTimeControl).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcEnergyConversionDevice).name()))) {
		distributionElement = new Ifc4::IfcEnergyConversionDevice(guid::IfcGloballyUniqueId(to_string(ifcElementBundle->getElementId())),
			ownerHistory, elementClassName, elementDescription, boost::none,
			file.addLocalPlacement(objectPlacement), shape, boost::none);
	}
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcEngine).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcEvaporativeCooler).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcEvaporator).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcFan).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcFilter).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcFireSuppressionTerminal).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcFlowController).name()))) {
		distributionElement = new Ifc4::IfcFlowController(guid::IfcGloballyUniqueId(to_string(ifcElementBundle->getElementId())),
			ownerHistory, elementClassName, elementDescription, boost::none,
			file.addLocalPlacement(objectPlacement), shape, boost::none);
	}
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcFlowInstrument).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcFlowMeter).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcFlowMovingDevice).name()))) {
		distributionElement = new Ifc4::IfcFlowMovingDevice(guid::IfcGloballyUniqueId(to_string(ifcElementBundle->getElementId())),
			ownerHistory, elementClassName, elementDescription, boost::none,
			file.addLocalPlacement(objectPlacement), shape, boost::none);
	}
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcFlowSegment).name()))) {
		distributionElement = new Ifc4::IfcFlowSegment(guid::IfcGloballyUniqueId(to_string(ifcElementBundle->getElementId())),
			ownerHistory, elementClassName, elementDescription, boost::none,
			file.addLocalPlacement(objectPlacement), shape, boost::none);
	}
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcFlowStorageDevice).name()))) {
		distributionElement = new Ifc4::IfcFlowStorageDevice(guid::IfcGloballyUniqueId(to_string(ifcElementBundle->getElementId())),
			ownerHistory, elementClassName, elementDescription, boost::none,
			file.addLocalPlacement(objectPlacement), shape, boost::none);
	}
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcFlowTerminal).name()))) {
		distributionElement = new Ifc4::IfcFlowTerminal(guid::IfcGloballyUniqueId(to_string(ifcElementBundle->getElementId())),
			ownerHistory, elementClassName, elementDescription, boost::none,
			file.addLocalPlacement(objectPlacement), shape, boost::none);
	}
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcFlowTreatmentDevice).name()))) {
		distributionElement = new Ifc4::IfcFlowTreatmentDevice(guid::IfcGloballyUniqueId(to_string(ifcElementBundle->getElementId())),
			ownerHistory, elementClassName, elementDescription, boost::none,
			file.addLocalPlacement(objectPlacement), shape, boost::none);
	}
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcHeatExchanger).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcHumidifier).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcInterceptor).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcJunctionBox).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcLamp).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcLightFixture).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcMedicalDevice).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcMotorConnection).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcOutlet).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcPipeFitting).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcPipeSegment).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcProtectiveDevice).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcProtectiveDeviceTrippingUnit).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcPump).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcSanitaryTerminal).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcSensor).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcSolarDevice).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcSpaceHeater).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcStackTerminal).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcSwitchingDevice).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcTank).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcTransformer).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcTubeBundle).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcUnitaryControlElement).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcUnitaryEquipment).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcValve).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcWasteTerminal).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcDistributionElement).name()))) {
...
Ifc4::IfcElementAssembly * IfcElementBuilder::handleIfcElementAssembly(string nameIfcElement,Ifc4::IfcProductDefinitionShape * shape, IfcElementBundle * ifcElementBundle, IfcHierarchyHelper<Ifc4>& file)
{
	_logger->logDebug(__FILE__, __LINE__, __func__);
	...
	if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcElementAssembly).name()))) {
...
Ifc4::IfcElementComponent * IfcElementBuilder::handleIfcElementComponent(string nameIfcElement,Ifc4::IfcProductDefinitionShape * shape, IfcElementBundle * ifcElementBundle, IfcHierarchyHelper<Ifc4>& file)
{
	_logger->logDebug(__FILE__, __LINE__, __func__);
	...
	if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcBuildingElementPart).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcDiscreteAccessory).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcFastener).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcMechanicalFastener).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcReinforcingBar).name()))) {
		// TODO replace the measurement values
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcReinforcingElement).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcReinforcingMesh).name()))) {
		// TODO replace the measurement values
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcTendon).name()))) {
		// TODO replace the measurement values
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcTendonAnchor).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcVibrationIsolator).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcElementComponent).name()))) {
...
Ifc4::IfcFeatureElement * IfcElementBuilder::handleIfcFeatureElement(string nameIfcElement,Ifc4::IfcProductDefinitionShape * shape, IfcElementBundle * ifcElementBundle, IfcHierarchyHelper<Ifc4>& file)
{
	_logger->logDebug(__FILE__, __LINE__, __func__);
	...
	if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcFeatureElementAddition).name()))) {
		featureElement = new Ifc4::IfcFeatureElementAddition(guid::IfcGloballyUniqueId(to_string(ifcElementBundle->getElementId())),
			ownerHistory, elementClassName, elementDescription, boost::none,
			file.addLocalPlacement(objectPlacement), shape, boost::none);

	}
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcFeatureElementSubtraction).name()))) {
		featureElement = new Ifc4::IfcFeatureElementSubtraction(guid::IfcGloballyUniqueId(to_string(ifcElementBundle->getElementId())),
			ownerHistory, elementClassName, elementDescription, boost::none,
			file.addLocalPlacement(objectPlacement), shape, boost::none);
	}
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcOpeningElement).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcOpeningStandardCase).name()))) {
		featureElement = new Ifc4::IfcOpeningStandardCase(guid::IfcGloballyUniqueId(to_string(ifcElementBundle->getElementId())),
			ownerHistory, elementClassName, elementDescription, boost::none,
			file.addLocalPlacement(objectPlacement), shape, boost::none, Ifc4::IfcOpeningElementTypeEnum::IfcOpeningElementType_NOTDEFINED);
	}
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcProjectionElement).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcSurfaceFeature).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcVoidingFeature).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcFeatureElement).name()))) {
...
Ifc4::IfcFurnishingElement * IfcElementBuilder::handleIfcFurnishingElement(string nameIfcElement,Ifc4::IfcProductDefinitionShape * shape, IfcElementBundle * ifcElementBundle, IfcHierarchyHelper<Ifc4>& file)
{
	_logger->logDebug(__FILE__, __LINE__, __func__);
	...
	if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcFurniture).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcSystemFurnitureElement).name()))) {
	...
	else if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcFurnishingElement).name()))) {
...
Ifc4::IfcGeographicElement * IfcElementBuilder::handleIfcGeographicElement(string nameIfcElement,Ifc4::IfcProductDefinitionShape * shape, IfcElementBundle * ifcElementBundle, IfcHierarchyHelper<Ifc4>& file)
{
	_logger->logDebug(__FILE__, __LINE__, __func__);
	...
	if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcGeographicElement).name()))) {
...
Ifc4::IfcTransportElement * IfcElementBuilder::handleIfcTransportElement(string nameIfcElement,Ifc4::IfcProductDefinitionShape * shape, IfcElementBundle * ifcElementBundle, IfcHierarchyHelper<Ifc4>& file)
{
	_logger->logDebug(__FILE__, __LINE__, __func__);
	...
	if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcTransportElement).name()))) {
...
Ifc4::IfcVirtualElement * IfcElementBuilder::handleIfcVirtualElement(string nameIfcElement,Ifc4::IfcProductDefinitionShape * shape, IfcElementBundle * ifcElementBundle, IfcHierarchyHelper<Ifc4>& file)
{
	_logger->logDebug(__FILE__, __LINE__, __func__);
	...
	if (boost::iequals(nameIfcElement, StringUtils::getIfcClassName(typeid(Ifc4::IfcVirtualElement).name()))) {
