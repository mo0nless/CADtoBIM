...
Ifc4::IfcGeometricRepresentationItem* IfcBooleanOperatorHandler::solveBooleanOperation(Ifc4::IfcGeometricRepresentationItem* leftIfcRepresentationItem,
...
//Ifc4::IfcGeometricRepresentationItem * IfcBooleanOperatorHandler::solveBooleanOperation(Ifc4::IfcElement * leftIfcElement, Ifc4::IfcElement * rightIfcElement, IfcReaderPropertiesBundle & ifcReaderPropertiesBundle)
//{
//	BooleanFunctions::BooleanFunctionsEnum booleanFunctionsEnum;
//	for (auto const& modelerProperty : ifcReaderPropertiesBundle.getReaderPropertiesBundle()->getProperties()) {
//		if (modelerProperty->getPropertyName() == "BooleanFunction") {
...
//	}
//
//	if (leftIfcElement != nullptr && rightIfcElement != nullptr) {
//		return new Ifc4::IfcBooleanResult(ifcOperatorBool, leftIfcElement, rightIfcElement);
//	}
//
//	return nullptr;
//}
