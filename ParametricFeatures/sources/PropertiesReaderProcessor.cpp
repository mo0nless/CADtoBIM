...
void PropertiesReaderProcessor::processPropertiesOfNonSmartFeature(ElementHandleCR currentElem, std::ofstream & outfile, std::string & filePath, DictionaryProperties & dictionaryProperties)
{
	WString elDescr;
